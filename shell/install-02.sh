...
DOWNLOAD_BASE_URL="https://github.com/potala2008/easypanel/raw/master/package";
restore_config()
{
...
function setup_kangle
{
	...
	KANGLE_URL="$DOWNLOAD_BASE_URL/kangle/kangle-$KANGLE_VERSION.tar.gz"
...
function setup_pureftpd
{
	...
	del_proftpd
	DOWN_URL="$DOWNLOAD_BASE_URL/pureftpd/pure-ftpd-$PUREFTP_VERSION.tar.gz"
